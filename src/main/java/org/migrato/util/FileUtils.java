...
import org.migrato.xmlbeans.GenericBean;
...
public class FileUtils {
	...
	@SuppressWarnings("unchecked")
	public static <T extends GenericBean> String writeFile(T bean,String filePath) throws JAXBException, IOException{
       ...
       // System.out.println(sw.toString());
        String finalPath= writeFileToDisk(filePath,sw.toString());
        return finalPath;
	}

	public static String writeFileToDisk(String filePath, String content) throws IOException {
		String finalPath=filePath+"\\object.xml";
		File file = new File(filePath+"\\object.xml");
	...
	public static void populateDirectoryMap(final File folder, String folderToExclude) {
	    for (final File fileEntry : folder.listFiles()) {
	        if (fileEntry.isDirectory() && DirectoryNames.contains(fileEntry.getName()) && !fileEntry.getName().equalsIgnoreCase(folderToExclude)) {
	        	getFilesFromCurrentFolder(fileEntry);
	        }
	    }
	}
